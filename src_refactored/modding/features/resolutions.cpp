...
// For 35 resolutions: CMP uses 0x23 (35), MOV uses 0x22 (34 = max index).

constexpr u8 kResListSize1[] = { 0x83, 0xBD, 0xE0, 0xFD, 0xFF, 0xFF, 0x23 };              // cmp [ebp-0x220], 35
constexpr u8 kResListSize2[] = { 0x83, 0xBD, 0xC4, 0xFD, 0xFF, 0xFF, 0x23 };              // cmp [ebp-0x23C], 35
constexpr u8 kResListSize3[] = { 0xC7, 0x45, 0xE8, 0x22, 0x00, 0x00, 0x00 };              // mov [ebp-0x18], 34
constexpr u8 kResListSize4[] = { 0xC7, 0x45, 0xD4, 0x22, 0x00, 0x00, 0x00 };              // mov [ebp-0x2C], 34
constexpr u8 kResListSize5[] = { 0xC7, 0x45, 0xC0, 0x22, 0x00, 0x00, 0x00 };              // mov [ebp-0x40], 34
